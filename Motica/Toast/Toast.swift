...
class Toast: NSObject {
    ...
    static func long(message: String,success: String,failer: String) {
        ...
        DispatchQueue.main.async {
            ...
            if success == "1"
            {
                t.toastView?.imageV.backgroundColor = UIColor.init(red: 0/255.0, green: 0/255.0, blue: 255/255.0, alpha: 1)
...
if success == "1"
            {
                t.toastView?.imageV.backgroundColor = UIColor.init(red: 30/255.0, green: 144/255.0, blue: 255/255.0, alpha: 1)
                //t.toastView?.imageV.image = UIImage(named: "toest_success")
            }
            else
            {
